            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.editUser',$user->id) }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            <label for="dateofbirthday" class="col-md-4 col-form-label text-md-right">{{ __('Date of birthday') }}</label>

                            <div class="col-md-6">
                                <input id="dateofbirthday" type="date" class="form-control @error('dateofbirthday') is-invalid @enderror" name="dateofbirthday" value="{{ Carbon\Carbon::parse($user->dateofbirthday)->format('m/d/Y') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="gender" class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ $user->gender }}" required autocomplete="gender" autofocus>
                                    ...
                                    <option @if($user->gender == 2) selected @endif value="2">Famele</option>
                                </select>
                                @error('gender')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
