                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dateofbirthday" type="date" class="form-control @error('dateofbirthday') is-invalid @enderror" name="dateofbirthday"  required autocomplete="name" autofocus>
